...
import { Employee, ResourceType, Title } from 'app/shared/models/Employee';
...
export class ResourceComponent implements OnInit,OnDestroy{
  ...
  getDisplayedColumns() {
    return ['photo', 'serialNumber','firstName','title', 'type','actions'];
  }
  ...
  resourceTypeMap={
    [ResourceType.BACKOFFICE_RESOURCE] : 'BackOffice',
    [ResourceType.INTERNAL_RESOURCE] : 'Interne',
    [ResourceType.EXTERNAL_RESOURCE] : 'Externe'
  };
  /***************************************  Modifier employé ****************************************************/
  /*
