...
export class EquipmentService {
  private apiUrl = 'http://localhost:8085/rh/equipment';
   ...
   private apiUrlAssEqEm = 'http://localhost:8085/rh/assEquipmentEmployee';
  ...
  constructor(private http : HttpClient) { 
    ...
    getEmployeeById(id: number): Observable<Employee> {
      const url = `${this.apiUrlEmployee}/get/${id}`;
  ...
  updateMotifById(id: number, motifUnavailability: string, disponibilityDate: Date): Observable<any> {
    ...
    /********************************************   Api update restitution *************************************************/  

    updateRestitutionById(id: number, returnComment: string, returnStatus : string ,returnDate: Date): Observable<any> {
      const url = `${this.apiUrl}/updateRestituationById/${id}`;
      return this.http.put<any>(url, { returnComment, returnStatus ,returnDate }).pipe(
        catchError(this.handleError)
      );
    }
...
/***************************************** les statistiques *************************************************/
    getAllAvailableAff(): Observable<any> {
      return this.http.get<any>(this.apiUrl + '/countAvailableAff').pipe(
        catchError(this.handleError)
      );
    }
    getAllUnavailableAff(): Observable<any> {
      return this.http.get<any>(this.apiUrl + '/countUnavailableAff').pipe(
        catchError(this.handleError)
      );
    }
    getAllAffected(): Observable<any> {
      return this.http.get<any>(this.apiUrl + '/countAffectation').pipe(
        catchError(this.handleError)
      );
    }
    getAllUnaffected(): Observable<any> {
      return this.http.get<any>(this.apiUrl + '/countUnaffectation').pipe(
        catchError(this.handleError)
      );
    }
    ...
    // Get employee first and last name  by equipement id
    findEmployeeNamesByEquipmentId(equipmentId: number): Observable<any> {
  const url = `${this.apiUrlEmployee}/findEmployeeNamesByEquipmentId/${equipmentId}`;
