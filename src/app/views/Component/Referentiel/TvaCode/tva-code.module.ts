...
import { TvaCodeRoutes } from './tva-code.routing';
...
@NgModule({
  declarations: [
   CreateTvaCodeComponent,
   ListTvaCodeComponent,
   ViewTvaCodeComponent
  ...
  imports: [
    ...
    MatDatepickerModule,
    MatExpansionModule,
    RouterModule.forChild(TvaCodeRoutes)
  ]
})
export class TvaCodeModule { }
