...
import { CalculationUnitRoutes } from './calculation-unit.routing';



@NgModule({
  declarations: [
  CreateCalculationUnitComponent,
  ViewCalculationUnitComponent,
  ListCalculationUnitComponent
  ...
  imports: [
    ...
    MatDatepickerModule,
    MatExpansionModule,
    RouterModule.forChild(CalculationUnitRoutes)
  ]
})
export class CalculationUnitModule { }
