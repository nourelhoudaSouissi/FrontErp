...
@NgModule({
  ...
  declarations: [ForgotPasswordComponent, LockscreenComponent,Signup4Component, Signin4Component,SigninComponent, SignupComponent, NotFoundComponent, ErrorComponent, Signup2Component, Signup3Component, Signin3Component, Signin2Component, ResetPasswordComponent]
})
